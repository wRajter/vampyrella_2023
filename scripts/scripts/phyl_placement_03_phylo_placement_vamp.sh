...
QUERY_SEQS="${RAW_DATA}/phyl_placement/eukaryotes/downstream_analyses/extract_otus/allsamples_sequences/Vampyrellida.fasta"
OUT_DIR="${RAW_DATA}/phyl_placement/vampyrellida/phyl_placement_analysis/allsamples"
