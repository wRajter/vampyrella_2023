...
SIM="sim_90"
RAW_DATA="../../raw_data"
PHY_PLAC_DIR="${RAW_DATA}/phyl_placement/${PROJECT}/${MARKER}/${DENOISE_METHOD}/${SIM}"
JPLACE_DIR="${PHY_PLAC_DIR}/${TAXON}/phyl_placement_analysis"
OUT_DIR="${PHY_PLAC_DIR}/${TAXON}/downstream_analyses"
REF_VERSION="2023"
TAXON_FILE="${RAW_DATA}/reference_alignments/vamp_phylo_placement/${TAXON}/reference_alignment_${REF_VERSION}/taxon_file.tsv"
QUERY_DIR="${PHY_PLAC_DIR}/eukaryotes/downstream_analyses/extract_otus"
